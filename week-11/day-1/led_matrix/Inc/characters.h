#ifndef __CHARACTERS_H_INCLUDED
#define __CHARACTERS_H_INCLUDED

#include <stdint.h>

uint8_t ascii_size = 96;

// Useful ASCII character set
// in row data format
const uint16_t ascii_row[][7] = {
...
// Same character set as above
// but in column data format
// This is needed for scrolling text
const uint16_t ascii_col[][5] = {
